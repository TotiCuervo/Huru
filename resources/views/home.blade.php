...
<nav class="navbar main-nav fixed-top navbar-expand-lg">
    <div class="container">
        <a class="navbar-brand" href="homepage.html"><img src="images/HuruLogo.png" alt="logo" style="height:70px;"></a>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="image-block">
                    <img class="img-fluid" src="images/phones/iphone-banner-huru.png" alt="iphone-banner">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-5 mr-auto">
                <!-- Image Content -->
                <div class="image-block">
                    <img src="images/phones/iphone-feature-2.png" alt="iphone-feature" class="img-fluid">
                    {{--<img src="images/amazon-echo-2.png" alt="iphone-feature" class="img-fluid">--}}
                </div>
            </div>
        ...
        <div class="row bg-elipse">
            ...
            <div class="col-lg-4 text-center">
                ...
                <div class="app-screen">
                    <img class="img-fluid" src="images/phones/dashboard.jpg" alt="app-screen">
                </div>
                <!-- Feature Item -->
                <div class="feature-item">
                    <!-- Icon -->
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4" align="center">
                <div class="counter-item">
                    ...
                    <div class="text-center">
                        <img src="images/healthkit.png" alt="healthKit">
            ...
            <div class="col-lg-3 col-md-4" align="center">
                <div class="counter-item">
                    ...
                    <!-- Counter Name -->
                    <div class="text-center">
                        <img src="images/alexa.png" alt="healthKit" style="height: 80%; width: 80%;">
            ...
            <div class="col-lg-4 col-md-3" align="center">
                <div class="counter-item">
                    ...
                    <!-- Counter Name -->
                    <div class="text-center">
                        <img src="images/huruIcon.png" alt="healthKit" style="padding-top:30px; height: 40%; width: 40%;">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-2 col-md-5">
                ...
                <div class="team-member text-center">
                    <div class="image">
                        <img class="img-fluid" src="images/team/kareem.png" alt="team-member">
                    </div>
                    <div class="name">
            ...
            <div class="col-lg-2 col-md-5">
                ...
                <div class="team-member text-center">
                    <div class="image">
                        <img class="img-fluid" src="images/team/Mykalia.png" alt="team-member">
                    </div>
                    <div class="name">
            ...
            <div class="col-lg-2 col-md-5">
                ...
                <div class="team-member text-center">
                    <div class="image">
                        <img class="img-fluid" src="images/team/malcolm.png" alt="team-member">
                    </div>
                    <div class="name">
            ...
            <div class="col-lg-2 col-md-5">
                ...
                <div class="team-member text-center">
                    <div class="image">
                        <img class="img-fluid" src="images/team/Omar.png" alt="team-member">
                    </div>
                    <div class="name">
                        <h5>Omar Alghamdi</h5>
                    </div>
            ...
            <div class="col-lg-2 col-md-5">
                ...
                <div class="team-member text-center">
                    <div class="image">
                        <img class="img-fluid" src="images/team/toti.png" alt="team-member">
                    </div>
                    <div class="name">
                        <h5>Toti Cuervo</h5>
                    </div>
...
<section class="cta-download bg-3 overlay">
    <div class="container">
        <div class="row">
            <div class="col-lg-5">
                <div class="image-block"><img class="img-fluid" src="images/phones/iphone-feature-2.png" alt=""></div>
            </div>
            <div class="col-lg-7">
                <div class="content-block">
                    <!-- Title -->
        ...
        <div class="row">
            <div class="col-lg-6 mr-auto">
                <div class="footer-logo">
                    <img src="images/HuruLogo.png" alt="footer-logo" style="height:70px;">
                </div>
                {{--<div class="copyright">--}}
